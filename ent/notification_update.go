...
func (_u *NotificationUpdate) SetHotspotID(v string) *NotificationUpdate {
	_u.mutation.SetHotspotID(v)
	return _u
}

// SetNillableHotspotID sets the "hotspot_id" field if the given value is not nil.
func (_u *NotificationUpdate) SetNillableHotspotID(v *string) *NotificationUpdate {
	if v != nil {
		_u.SetHotspotID(*v)
	}
	return _u
...
func (_u *NotificationUpdate) ClearHotspotID() *NotificationUpdate {
	_u.mutation.ClearHotspotID()
	return _u
}

// SetHotspot sets the "hotspot" edge to the Hotspot entity.
func (_u *NotificationUpdate) SetHotspot(v *Hotspot) *NotificationUpdate {
	return _u.SetHotspotID(v.ID)
}
...
func (_u *NotificationUpdate) ClearHotspot() *NotificationUpdate {
	_u.mutation.ClearHotspot()
	return _u
}
...
func (_u *NotificationUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if nodes := _u.mutation.HotspotIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   notification.HotspotTable,
...
// SetHotspotID sets the "hotspot_id" field.
func (_u *NotificationUpdateOne) SetHotspotID(v string) *NotificationUpdateOne {
	_u.mutation.SetHotspotID(v)
	return _u
}

// SetNillableHotspotID sets the "hotspot_id" field if the given value is not nil.
func (_u *NotificationUpdateOne) SetNillableHotspotID(v *string) *NotificationUpdateOne {
	if v != nil {
		_u.SetHotspotID(*v)
	}
	return _u
...
// ClearHotspotID clears the value of the "hotspot_id" field.
func (_u *NotificationUpdateOne) ClearHotspotID() *NotificationUpdateOne {
	_u.mutation.ClearHotspotID()
	return _u
}

// SetHotspot sets the "hotspot" edge to the Hotspot entity.
func (_u *NotificationUpdateOne) SetHotspot(v *Hotspot) *NotificationUpdateOne {
	return _u.SetHotspotID(v.ID)
}
...
// ClearHotspot clears the "hotspot" edge to the Hotspot entity.
func (_u *NotificationUpdateOne) ClearHotspot() *NotificationUpdateOne {
	_u.mutation.ClearHotspot()
	return _u
}
